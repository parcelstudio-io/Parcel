"""Deployment-disabled supervisory local tracker for the V9 S3 scratch lane.
...
class SampledPredictiveTracker:
    ...
    def select(
        ...
        *,
        ...
        if self._searching_for_gap and self._search_exhausted and route_available and waypoint:
    ...
    def _continue_gap_search(
        ...
        *,
        ...
        return MidLevelCommand(
            ...
            stop=False,
            note=(
                "v9s3_active_gap_search_exhausted "
    ...
    def _hold(self, reason: str, *, extra: str = "") -> MidLevelCommand:
        ...
        return MidLevelCommand(
            ...
            vyaw=0.0,
            stop=False,
            note=f"v9s3_supervisor_hold reason={reason}{suffix}",
        )
