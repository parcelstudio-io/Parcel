"""Deployment-disabled supervisory local tracker for the V9 S5 scratch lane.
...
class SampledPredictiveTracker:
    ...
    def _hold(self, reason: str, *, extra: str = "") -> MidLevelCommand:
        ...
        return MidLevelCommand(
            ...
            vyaw=0.0,
            stop=False,
            note=f"v9s5_supervisor_hold reason={reason}{suffix}",
        )
    ...
    def _braking_hold(self, reason: str, *, extra: str = "") -> MidLevelCommand:
        ...
        return MidLevelCommand(
            ...
            vyaw=yaw,
            stop=False,
            note=f"v9s5_supervisor_hold reason={reason} braking=true{suffix}",
        )
