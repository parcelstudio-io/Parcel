"""Verify and materialize the frozen V9 supervisory-gap S3 challenger.

S3 is a deployment-disabled, training-only successor to S2.  The exact
...
SCRATCH_FREEZE_SHA256 = "88b18be078b042966b4e7c02ea2ba84dc93c750a37fd526e77a4e9ec795088ca"
SOURCE_CONTRACT_SHA256 = "166ebfe518306dedaa13d539b0aa611a0ec4f2058020e661d9a397f7d026af36"
CANDIDATE_PACKAGE_SHA256 = "258e9a33e706babe236dd8bd517839c6ddc085ccbfc750532f1a0ce7baeec1a6"
CANDIDATE_MANIFEST_SHA256 = "72f1aa60a2240e9f8f68ce00c3ee253ac203b470961e8f0f8fbfa943adb86aba"
...
class SupervisoryGapS3Error(RuntimeError):
    """Raised when the S3 challenger no longer matches its freeze."""


@dataclass(frozen=True, slots=True)
class VerifiedSupervisoryGapS3:
...
def _strict_json(raw: bytes) -> dict[str, Any]:
    ...
    try:
        ...
        raise SupervisoryGapS3Error("scratch freeze is not strict JSON") from error
    if not isinstance(value, dict):
        raise SupervisoryGapS3Error("scratch freeze must contain an object")
    return value
...
def _read_unique_regular(path: str | Path) -> tuple[Path, bytes]:
    ...
    try:
        ...
        raise SupervisoryGapS3Error(f"scratch freeze is missing: {requested}") from None
...
def verify_supervisory_gap_s3(
    *,
    ...
    if observed_sha != SCRATCH_FREEZE_SHA256:
        raise SupervisoryGapS3Error("scratch freeze raw identity changed")
    ...
    if (
        ...
        != "parcel-v9-supervisory-gap-s3-scratch-candidate-freeze-v1"
        ...
        != "parcel-v9-supervisory-gap-s3-training-screen10-gate-v1"
        ...
        raise SupervisoryGapS3Error("scratch freeze semantic contract is invalid")
    ...
    return VerifiedSupervisoryGapS3(
        plan=plan,
...
def prepare_supervisory_gap_s3_bundle(
    *,
    destination_root: str | Path,
) -> V9CandidateBundle:
    """Materialize the exact challenger only after its freeze re-verifies."""

    verified = verify_supervisory_gap_s3()
...
__all__ = [
    ...
    "SupervisoryGapS3Error",
    "VerifiedSupervisoryGapS3",
    "prepare_supervisory_gap_s3_bundle",
    "verify_supervisory_gap_s3",
]
