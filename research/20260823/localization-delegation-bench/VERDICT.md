...
| L4 | DEGRADED ≤ 1 s on dropout; LOST on teleport; recovery reported | DEGRADED +0.4 s, LOST +2.9 s, recovery 0.1 s; teleport LOST +0.2 s, recovery 0.4 s | contract path unit-tested (`test_h7_localization_contract.py`) | CONFIRMED |
...
**Overall: CONFIRMED-WITH-NOTES; L5 REFUTED.** Product path: `localization/`
