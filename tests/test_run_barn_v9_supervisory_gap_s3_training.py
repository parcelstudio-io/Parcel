...
from evals.external import run_barn_v9_supervisory_gap_s3_training as runner
from evals.external import run_sampled_predictive_tracker_v9_training as shared
from evals.external.barn_v9_supervisory_gap_s3 import (
...
def test_real_preflight_authenticates_s3_bundle_corpus_and_isolated_pair() -> None:
...
def test_s3_has_no_100_world_development_holdout_or_path_override(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.setattr(
        shared,
